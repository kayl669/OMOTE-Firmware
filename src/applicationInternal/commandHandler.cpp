...
void register_keyboardCommands() {
  ...
  KEYBOARD_UP                  = KEYBOARD_BLE_FREEBOX_UP;
  KEYBOARD_DOWN                = KEYBOARD_BLE_FREEBOX_DOWN;
  KEYBOARD_RIGHT               = KEYBOARD_BLE_FREEBOX_RIGHT;
  KEYBOARD_LEFT                = KEYBOARD_BLE_FREEBOX_LEFT;
  KEYBOARD_SELECT              = KEYBOARD_BLE_FREEBOX_SELECT;
  KEYBOARD_SENDSTRING          = KEYBOARD_BLE_FREEBOX_SENDSTRING;
  KEYBOARD_BACK                = KEYBOARD_BLE_FREEBOX_BACK;
  KEYBOARD_HOME                = KEYBOARD_BLE_FREEBOX_HOME;
  KEYBOARD_MENU                = KEYBOARD_BLE_FREEBOX_MENU;
  KEYBOARD_SCAN_PREVIOUS_TRACK = KEYBOARD_BLE_FREEBOX_SCAN_PREVIOUS_TRACK;
  KEYBOARD_REWIND_LONG         = KEYBOARD_BLE_FREEBOX_REWIND_LONG;
  KEYBOARD_REWIND              = KEYBOARD_BLE_FREEBOX_REWIND;
  KEYBOARD_PLAYPAUSE           = KEYBOARD_BLE_FREEBOX_PLAYPAUSE;
  KEYBOARD_FASTFORWARD         = KEYBOARD_BLE_FREEBOX_FASTFORWARD;
  KEYBOARD_FASTFORWARD_LONG    = KEYBOARD_BLE_FREEBOX_FASTFORWARD_LONG;
  KEYBOARD_SCAN_NEXT_TRACK     = KEYBOARD_BLE_FREEBOX_SCAN_NEXT_TRACK;
  KEYBOARD_MUTE                = KEYBOARD_BLE_FREEBOX_MUTE;
  KEYBOARD_VOLUME_INCREMENT    = KEYBOARD_BLE_FREEBOX_VOLUME_INCREMENT;
  KEYBOARD_VOLUME_DECREMENT    = KEYBOARD_BLE_FREEBOX_VOLUME_DECREMENT;
